...
// cprequire_test(["inline:com-chilipeppr-workspace-martin84"], function(ws) {
...
// cpdefine("inline:com-chilipeppr-workspace-martin84", ["chilipeppr_ready"], function() {
//     return {
//         /**
//         * The ID of the widget. You must define this and make it unique.
//         */
//         id: "com-chilipeppr-workspace-martin84", // Make the id the same as the cpdefine id
//         name: "Workspace / martin84", // The descriptive name of your widget.
...
//             this.loaddViewerWidget();

//             this.loadgCodelistWidget();

//             this.loadNRdashboardWidget();

//             this.loadAxisWidget();
            
//             this.loadWebcamWidget();
...
//         /**
//         * Load the NR dashboard widget.
//         * 
//         */
//         loadNRdashboardWidget: function(callback) {

//             chilipeppr.load(
//               "#com-chilipeppr-nde-red-dashboard-widget",
...
//         */
//         loaddViewerWidget: function(callback) {
...
// chilipeppr.load("#com-chilipeppr-widget-3dviewer-instance",
...
//         /**
//         * Load the axis viewer widget via chilipeppr.load()
//         */
//         loadAxisWidget: function(callback) {

//             var that = this;

//             chilipeppr.load(
//               "#com-chilipeppr-widget-axis-widget-instance",
...
//         /**
//         * Load the webcam widget via chilipeppr.load()
//         */
//         loadWebcamWidget: function(callback) {
...
cpdefine("inline:com-chilipeppr-workspace-martin84", ["chilipeppr_ready"], function() {
    return {
        ...
        loadWidgets: function(callback) {
            ...
            // Node-RED dashboard
            chilipeppr.load(
              "#com-chilipeppr-widget-node-red-dashboard",
              "http://raw.githubusercontent.com/martin-84/widget-nde-red-dashbrd/master/auto-generated-widget.html",
              function() {
                // Callback after widget loaded into #myDivNdeRedDashbrd
                // Now use require.js to get reference to instantiated widget
